...
let selectedPose = 'A';  // default
document.addEventListener("DOMContentLoaded", function () {
    const poseSelect = document.getElementById("poseSelect");
    poseSelect.addEventListener("change", function () {
        selectedPose = this.value;
        document.getElementById("correctionMessage").textContent = ""; // Reset message
    });
});
...
function gotResults(err, result) {
  ...
  let predictedPose = pose_arr[mx_indx];

// Posture correction check
  if (predictedPose === selectedPose) {
      document.getElementById("correctionMessage").textContent = "✅ Good posture!";
      document.getElementById("correctionMessage").style.color = "lightgreen";
  } else {
      document.getElementById("correctionMessage").textContent = "❌ Try adjusting your posture!";
      document.getElementById("correctionMessage").style.color = "orange";
  }
   console.log(mx_indx);
